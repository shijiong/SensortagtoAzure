...
namespace BluetoothGATT
{
    ...
    /// </summary>
    ///    
    public class SensorTagEntity : TableEntity
    {
        public SensorTagEntity()
        {
            this.PartitionKey = "WindowsIoTCore";
    ...
    public sealed partial class MainPage : Page
    {
        ...
        //temporary data
        private double tempThermometerAmbTemp = 0.0;
        private double tempThermometerObjTemp = 0.0;
        private double tempAccelerometerX = 0.0;
        private double tempAccelerometerY = 0.0;
        private double tempAccelerometerZ = 0.0;
        private double tempHumidityRelHum = 0.0;
        private double tempHumidityRelTemp = 0.0;
        private double tempMagnetometerX = 0.0;
        private double tempMagnetometerY = 0.0;
        private double tempMagnetometerZ = 0.0;
        private double tempBarometerAmbPres = 0.0;
        private double tempBarometerAmbTemp = 0.0;
        private double tempGyroscopeX = 0.0;
        private double tempGyroscopeY = 0.0;
        private double tempGyroscopeZ = 0.0;
        ...
        private async void dataTransmitterTick(ThreadPoolTimer timer)
        {
            try
            {
                ...
                CloudTable table = tableClient.GetTableReference("SensorTagTable");
                await table.CreateIfNotExistsAsync();

                // Create a new customer entity.
                SensorTagEntity ent = new SensorTagEntity();
                ...
                ent.MagnetometerX = tempMagnetometerX;
                ent.MagnetometerY = tempMagnetometerY;
                ent.MagnetometerZ = tempMagnetometerZ;
                ent.GyroscopeX = tempGyroscopeX;
                ent.GyroscopeY = tempGyroscopeY;
                ent.GyroscopeZ = tempGyroscopeZ;
                ent.BarometerAmbPres = tempBarometerAmbPres;
                ent.HumidityRelHum = tempHumidityRelHum;
                ent.ThermometerAmbTemp = tempThermometerAmbTemp;
                ent.ThermometerObjTemp = tempThermometerObjTemp;
        ...
        async void tempChanged(GattCharacteristic sender, GattValueChangedEventArgs eventArgs)
        {
            ...
            tempThermometerAmbTemp = AmbTemp;
            tempThermometerObjTemp = tObj;
